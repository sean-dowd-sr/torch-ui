...
import { AlertDialogRootProps } from '@kobalte/core/alert-dialog';

interface AlertDialogProps extends Omit<AlertDialogRootProps, 'open' | 'onOpenChange'> {
...
export { AlertDialog as A, type AlertDialogProps as a };
