import { Pagination } from './YJG7DBSA.js';
import { normalizeHex, Avatar, neutralColorClass, shapeClasses, avatarSizeClasses, useIcons, Input, Button, Dialog, AlertDialog } from './VYBVD7AZ.js';
        ...
        return (() => {
          ...
          insert(_el$3, createComponent(Show, {
            ...
            get children() {
              ...
              effect(() => className(_el$5, cn("flex mr-1.5 shrink-0 items-center justify-center [&>svg]:h-4 [&>svg]:w-4", selected() ? "text-primary-500" : "text-ink-500")));
              return _el$5;
            }
          }), _el$6);
            ...
            return createComponent(TableCell, {
              ...
              get children() {
                return memo(() => !!local.emptyState)() ? createComponent(EmptyState, {
                  ...
                  var _el$ = _tmpl$17();
                  insert(_el$, () => local.emptyMessage ?? "No data");
                  return _el$;
                })();
              }
            });
